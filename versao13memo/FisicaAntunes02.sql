...
--
-- Host: localhost
-- Generation Time: 26-Set-2017 às 00:10
...
(1, 'Esp.jpg', 1),
(2, 'Like a G6.mp3', 1),
(3, 'oracao_sao_bento.jpg', 1),
(4, 'Captura de tela de 2017-09-18 16:51:18.png', 1),
(5, 'fotoPedro.jpg', 1);
...
--
-- Extraindo dados da tabela `arquivosTecnico`
--

INSERT INTO `arquivosTecnico` (`idArquivo`, `nomeArquivo`, `idTecnico`, `bimestre`) VALUES
(4, 'Einsten.jpg', 1, 3);
...
--
ALTER TABLE `arquivosDisciplina`
MODIFY `idArquivo` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=6;
--
